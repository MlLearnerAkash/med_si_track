...
def run(
    ...
    while videocapture.isOpened():
        ...
        # Extract the results
        results = model.track(frame, persist=True, classes=classes, conf = 0.50, save = False, imgsz = 2480, cfg = "/root/ws/med_si_track/ultralytics/cfg/trackers/botsort.yaml")
...
def parse_opt():
    ...
    parser.add_argument("--source", type=str,default="/mnt/data/needle_training.avi", required=False, help="video file path")
